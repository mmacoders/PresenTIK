            ...
            <form @submit.prevent="submitProfile" class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1">
                    <div class="bg-gradient-to-br from-red-100 to-blue-100 rounded-2xl shadow-sm border border-red-100 p-8 text-center sticky top-24">
                        ...
                        <p class="text-sm text-gray-900 mb-4">{{ user.nrp || user.nip || 'Admin' }}</p>
...
const submitProfile = () => {
    ...
    profileForm.post(route('admin.profil.update'), {
        forceFormData: true,
        onSuccess: () => {
...
const cancelChanges = () => {
    ...
    profileForm.no_hp = props.user.no_hp || props.user.phone || '';
